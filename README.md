...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/gsplat-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gsplat-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `gsplat` available on your platform:
...
```
pixi search gsplat --channel conda-forge
```
